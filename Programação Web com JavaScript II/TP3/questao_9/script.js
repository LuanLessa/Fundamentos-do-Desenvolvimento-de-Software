...
const fisico = figurasHistoricas.filter((o) => o.profissao.toLowerCase().includes("físico"));
const contribuicoes = fisico.map((o) => o.contribuicoes);
const contribuicoesFlat = contribuicoes.flat();
console.log(contribuicoesFlat);