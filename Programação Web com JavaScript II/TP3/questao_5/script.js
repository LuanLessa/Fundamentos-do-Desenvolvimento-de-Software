...
const ativista = figurasHistoricas.filter((o) => o.profissao.toLowerCase().includes("ativista"));
let somaIdade = 0;
ativista.forEach((o) => somaIdade += o.idade);
const mediaIdade = somaIdade / ativista.length;
